...
export class Backend implements backendInterface {
    ...
    async getMyFoods(): Promise<Array<FoodEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyFoods();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getNutritionTotals(): Promise<NutritionTotals> {
        if (this.processError) {
            try {
                const result = await this.actor.getNutritionTotals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async logFood(arg0: FoodEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logFood(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
